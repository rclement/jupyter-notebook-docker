...
#
#    from  import passwd; passwd()
#
#  The string should be of the form type:salt:hashed-password.
#  Default: ''
notebook_password = os.environ.get("JUPYTER_PASSWORD", secrets.token_hex(32))
hashed_password = notebook.auth.passwd(passphrase=notebook_password)
...
#  Choices: any of ['sha3_224', 'sha1', 'sha256', 'sha3_256', 'sha3_512', 'sha384', 'blake2b', 'sha512', 'sha3_384', 'sha224', 'blake2s', 'md5']
#  Default: 'sha256'
